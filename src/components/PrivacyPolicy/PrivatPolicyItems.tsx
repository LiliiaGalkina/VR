import style from "./privatpolicyitems.module.scss";

const PrivatPolicyItems = () => {
	return (
    <section className={style.policy}>
      ...
      <p className={style.text}>
        ...
        protects the personal information of our website visitors and customers.
      </p>
      ...
      <ul className={style.list}>
        ...
        <li className={style.listitem}>To improve our website and services.</li>
      </ul>
      <h4 className={style.blocktitle}>How We Protect Your Information</h4>
      <p className={style.blocktext}>
        We implement a variety of security measures to maintain the safety of
        your personal information when you place an order or enter, submit, or
        access your personal information. We use encryption to protect sensitive
...
export default PrivatPolicyItems;
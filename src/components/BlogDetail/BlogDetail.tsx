            ...
            <div className={style.content}>
              ...
              <div className={style.info}>
                <p className={style.text}>
                  ...
                  to computer-aided design (CAD) software. However, one
                  technology that is revolutionizing architecture is virtual
                  reality (VR) design.
                </p>
                <p className={style.text}>
                ...
                <p className={style.text}>
                  VR design is a game-changer for architects and clients alike.
                  It enables architects to design with a greater level of detail
                  and precision, allowing them to identify design flaws and make
                ...
                <p className={style.beforeimages}>
                  Moreover, VR design is not only limited to the design phase.
                  It can also be used in the construction process to visualize
                  the project's progress and identify any issues that may arise.
                </p>
